package com.global.springreview.config;
...
public class OpenApiConfig {
    ...
    private Contact getContact() {
        ...
        contact.setEmail("mahmoudrezk514@gmail.com");
        contact.setName("Review Services");
        contact.setUrl("https://www.review.com");
